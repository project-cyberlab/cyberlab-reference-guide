...
- **945 tools captured** with real help text — ready to document
- **83 present but no usable help** — GUI-only, or help needs arguments; document workflow rather than flags
- **791 not in either container** — need a booted VM (Kali, FLARE-VM Windows guest) or are GUI/appliance-only
