...
```
# Spawn and debug a program
r2 -d ls
# Load existing project file
r2 -p test
# Analyze raw binary dump for carving
r2 -n dump.bin
# Resize files to original size for carving analysis
r2 -wnqc"r $sz" $a
# Analyze FAT binary file structure and contents
