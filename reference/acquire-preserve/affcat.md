...
`ewfinfo`, `ewfmount`, `ewfverify`, `ewfexport`, `affinfo`, [`img_stat`](../acquire-preserve/img_stat.md), [`ntfs-3g`](../acquire-preserve/ntfs-3g.md), [`vshadowinfo`](../acquire-preserve/vshadowinfo.md)
