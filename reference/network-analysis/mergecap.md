...
**Kit:** REMnux · Kali Linux · FLARE-VM · SIFT Workstation  **Capability:** Split, merge or repair capture files  **Version:** Mergecap (Wireshark) 4.0.17.
**Captured:** `cyberlab-aio` via `--help` on 2026-08-02  [raw](../../capture/cyberlab-aio/help/mergecap.help.txt)  **Docs:** <https://www.wireshark.org>
