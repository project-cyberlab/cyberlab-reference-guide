...
All 59 options parsed from the captured help text. The final column is the judgement layer and is filled in by review.
...
| `--analysis` | PLUGIN_LIST | A comma separated list of analysis plugin names to be loaded or "--analysis list" to see a list of available plugins. | |
...
| `-o` | FORMAT | The output format. Use "-o list" to see a list of available output formats. | |
