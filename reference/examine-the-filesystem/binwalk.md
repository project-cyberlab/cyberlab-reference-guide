...
| **Captured from** | `cyberlab-aio` via `--help` on 2026-08-05 — [raw help output](../../capture/cyberlab-aio/help/binwalk.help.txt) |
...
[`foremost`](../examine-the-filesystem/foremost.md), [`scalpel`](../examine-the-filesystem/scalpel.md), [`bulk_extractor`](../examine-the-filesystem/bulk_extractor.md), [`tcpxtract`](../examine-the-filesystem/tcpxtract.md), [`upx`](../malware-triage-static/upx.md), [`die`](../malware-triage-static/die.md), [`diec`](../malware-triage-static/diec.md), [`7za`](../malware-triage-static/7za.md)
